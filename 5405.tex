...
\begin{tabular}{clccc p{.4cm}|p{.4cm}|p{.4cm}|p{.4cm}|p{.4cm}}% @{}}
  \multicolumn{10}{c}{График выполнения лабораторных работ студентами 54405 группы} \\
\toprule
	&&&\multicolumn{7}{c}{{\shortstack[c]{\\защита\\ лабораторных\\работ}}} \\
\cmidrule{6-10}
&
...
\midrule
	&&\rotatebox{90}{лаб.1} & &\rotatebox{90}{лаб.2} &&&&   \\
	&Бабская Ирина             \ok&&    &&&&\\
	&Пермяков Иван             \ok&&    &&&&\\
...
\cmidrule{1-10}
	& & &\rotatebox{90}{лaб.1} &\rotatebox{90}{лаб.3} &&&&\\
	&Бородкин Даниил         &\ok&   &&&&\\
	&Гостищев Иван           &\ok&   &&&&\\
