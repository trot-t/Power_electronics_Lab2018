...
\begin{tabular}{clcccc p{.4cm}|p{.4cm}|p{.4cm}|p{.4cm}|p{.4cm}}% @{}}
  \multicolumn{11}{c}{График выполнения лабораторных работ студентами 5405 группы} \\
\toprule
...
\midrule
	&&\rotatebox{90}{лаб.1} & &\rotatebox{90}{лаб.2} &\rotatebox{90}{лаб.3} &&&&   \\
	&Бабская Ирина             \ok&\ok&    &5&&&&\\
	&Пермяков Иван             \ok&\ok&    &5&&&&\\
\rotatebox{90}{\rlap{~бригада №1}}
	&Ачолону Гектор            \ok&\ok&    &5&&&&\\

\cmidrule{1-11}
	& &\rotatebox{90}{лaб.2} & &\rotatebox{90}{лaб.5} &&&&&\\
	&Вербова Алина            \ok&\ok&    &&п?&&\\
	&Власов Федор             \ok&\ok&    &&п?&&\\
\rotatebox{90}{\rlap{~бригада №2}}
	&Шэ Юйго                  \ok&\ok&    &&п?&&\\

\cmidrule{1-11}
	& &\rotatebox{90}{лaб.5} & &\rotatebox{90}{лaб.4} &&&&&\\
	&Слугинов Алексей         \ok&\ok&    &&&&&4\\
	&Семенов Владислав        \no&\ok&    &&&&&4\\
\rotatebox{90}{\rlap{~бригада №3}}
	&Дике-Ндулуе Патрик       \ok&\ok&    &&&&&4\\ 

\cmidrule{1-11}
	& &\rotatebox{90}{лaб.4} & &\rotatebox{90}{лaб.1} &&&&&\\
	&Сидюк Владислав         \ok&\ok&    &&&&?&\\
	&Джунусов Руслан         \ok&\ok&    &&&&?&\\
\rotatebox{90}{\rlap{~бригада №4}}
	&Ильяшов Дмитрий         \ok&\ok&    &&&&?&\\ 
